...
public class Tunnel{
  ...
  public void calculateStateVar(double localpg[][], double localtg[][],
			 Statevector localug[][])
  ...
  public void calculateG(double localpg[][], double localtg[][],
		  Statevector localug[][]) {
  ...
  public void calculateF(double localpg[][], double localtg[][],
		  Statevector localug[][]) {
  ...
  public void calculateDamping(double localpg[][], Statevector localug[][]) {
      double adt, sbar;
      double nu2;
      double nu4;
      double tempdouble;
  ...
  public void calculateDummyCells(double localpg[][],
